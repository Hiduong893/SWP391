                  ...
                  {incidentsList.map(item => {
                    ...
                    return (
                      <tr key={item.id}>
                        ...
                        <td style={{ maxWidth: 260, fontSize: 12.5, color: `var(--cskh-text-muted)` }}>
          ...
          <div className="cskh-card">
            ...
            {!selectedDispute ? (
              ...
              <div style={{ padding: 20 }}>
                <div style={{ marginBottom: 16 }}>
                  <div style={{ fontSize: 11, color: `var(--cskh-text-dim)`, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Người khiếu nại</div>
                  <div style={{ fontWeight: 600, color: `var(--cskh-text)` }}>{selectedDispute.userName}</div>
                </div>
                <div style={{ marginBottom: 16 }}>
                  <div style={{ fontSize: 11, color: `var(--cskh-text-dim)`, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Nội dung</div>
                  <div style={{ fontSize: 13, color: `var(--cskh-text-muted)`, lineHeight: 1.6, background: `var(--cskh-surface-2)`, borderRadius: 8, padding: '10px 14px' }}>
                ...
                {selectedDispute.status === 'resolved' ? (
                  ...
                  <form onSubmit={handleResolveDispute}>
                    <div style={{ marginBottom: 10, fontSize: 11, color: `var(--cskh-text-dim)`, textTransform: 'uppercase', letterSpacing: '0.08em' }}>Phán quyết của CSKH</div>
                    <textarea
